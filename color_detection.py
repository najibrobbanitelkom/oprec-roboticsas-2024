...
def main(video):
    while True:
        ...
        low = np.load('/home/fadhil/Documents/Materi_OpenCV/green_low.npy')  # Memuat batas bawah warna hijau dari file
        high = np.load('/home/fadhil/Documents/Materi_OpenCV/green_high.npy')  # Memuat batas atas warna hijau dari file
...
if __name__ == '__main__':
    cam = cv2.VideoCapture(-1)  # Membuka kamera default (index 0)
