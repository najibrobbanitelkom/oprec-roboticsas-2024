...
def main(video) :
    while True :
        ...
        low = np.load('/home/fizu/Downloads/Belajar Pyton/brown_low_npy.npy')
        high = np.load('/home/fizu/Downloads/Belajar Pyton/brown_High_npy.npy')
        ...
        # np.save('brown _low _npy', lower)
        # np.save('brown _High _npy', upper)
